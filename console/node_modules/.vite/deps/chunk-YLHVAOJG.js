...
function getChainElementLiteralValueAtPath(element, object, path2, recursionTracker, origin) {
  ...
  return element.getLiteralValueAtPath(path2, recursionTracker, origin);
}
...
var MemberExpression = class extends NodeBase {
  ...
  getLiteralValueAtPathAsChainElement(path2, recursionTracker, origin) {
    if (this.variable) {
      return this.variable.getLiteralValueAtPath(path2, recursionTracker, origin);
    }
    if (this.isUndefined) {
    ...
    return getChainElementLiteralValueAtPath(this, this.object, path2, recursionTracker, origin);
  }
  getReturnExpressionWhenCalledAtPath(path2, interaction, recursionTracker, origin) {
    if (this.variable) {
...
var CallExpression2 = class extends CallExpressionBase {
  ...
  getLiteralValueAtPathAsChainElement(path2, recursionTracker, origin) {
    return getChainElementLiteralValueAtPath(this, this.callee, path2, recursionTracker, origin);
  }
  hasEffects(context) {
    if (!this.deoptimized)
      this.applyDeoptimizations();
  ...
  hasEffectsAsChainElement(context) {
    ...
    return !this.annotationPure && this.callee.hasEffectsOnInteractionAtPath(EMPTY_PATH, this.interaction, context);
  }
  include(context, includeChildrenRecursively) {
    if (!this.deoptimized)
      this.applyDeoptimizations();
...
var ChainExpression = class extends NodeBase {
  ...
  getLiteralValueAtPath(path2, recursionTracker, origin) {
    const literalValue = this.expression.getLiteralValueAtPathAsChainElement(path2, recursionTracker, origin);
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-42DGNIHS.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-YLHVAOJG.js.map
